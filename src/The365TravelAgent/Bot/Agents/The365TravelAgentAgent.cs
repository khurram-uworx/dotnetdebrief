...
using The365TravelAgent.Bot.Plugins;

namespace The365TravelAgent.Bot.Agents;

public class The365TravelAgentAgent
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="The365TravelAgentAgent"/> class.
    /// </summary>
    ...
    public The365TravelAgentAgent(IChatClient chatClient, AgentApplication app, ITurnContext turnContext)
    {
